...
(:action do-grind-copy
	...
	:effect (and
		...
		(not (colour-copy ?x ?oldcolour))
		(colour-copy ?x natural)
		(grind-treatment-change-copy ?newtreatment ?newtreatment)(increase (total-cost ) (grind-cost ?x))))
...
(:action cut-board-small-copy
	...
	:effect (and
		...
		(boardsize-copy ?b ?size_after)
		(not (boardsize-copy ?b ?size_before))(increase (total-cost ) 10)))
