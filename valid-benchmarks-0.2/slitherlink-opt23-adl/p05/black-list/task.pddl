(define (problem sliterlink-355032)                       (:domain slitherlink)                       (:objects cell-outside-2-up - cell
cell-2-0 - cell
n-1-6 - node
...
(cell-edge-copy cell-4-0 cell-outside-0-down n-5-0 n-5-1)
(cell-capacity-copy cell-2-0 cap-3)
(cell-capacity-inc-copy cap-3 cap-4)
(cell-capacity-copy cell-2-5 cap-2)
...
(cell-capacity-copy cell-3-0 cap-2)
...
(cell-edge-copy cell-4-1 cell-outside-1-down n-5-1 n-5-2)
...
(node-degree0 n-2-4)
(cell-capacity-copy cell-4-2 cap-2)
(node-degree0 n-3-0)
(cell-edge-copy cell-4-4 cell-outside-4-down n-5-4 n-5-5)
...
(cell-capacity-copy cell-1-4 cap-2)
...
(cell-edge-copy cell-4-3 cell-outside-3-down n-5-3 n-5-4)
(node-degree0-copy n-4-1)
(node-degree0 n-4-6)
(cell-capacity-copy cell-3-5 cap-4)
(cell-capacity-copy cell-0-0 cap-3)
...
(cell-capacity-copy cell-3-1 cap-3)
...
(cell-capacity-copy cell-0-4 cap-1)
...
(node-degree0 n-3-2)
(cell-capacity-copy cell-1-3 cap-4)
(node-degree0 n-0-4)
...
(cell-edge-copy cell-4-2 cell-outside-2-down n-5-2 n-5-3)
...
(cell-capacity-copy cell-4-5 cap-2)
(cell-edge cell-3-3 cell-4-3 n-4-3 n-4-4)
(cell-capacity-copy cell-outside-4-right cap-1)
(cell-edge-copy cell-4-5 cell-outside-5-down n-5-5 n-5-6)
...
(cell-capacity-copy cell-1-5 cap-4)
...
(node-degree0 n-1-3)
(cell-capacity-copy cell-0-5 cap-3)
(cell-capacity cell-3-3 cap-2)
(cell-capacity cell-1-0 cap-4)
(cell-capacity-copy cell-3-2 cap-2)
