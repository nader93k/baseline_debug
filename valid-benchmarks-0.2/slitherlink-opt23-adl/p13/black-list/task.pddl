(define (problem sliterlink-638552)                       (:domain slitherlink)                       (:objects cell-5-4 - cell
...
(cell-capacity-copy cell-2-2 cap-2)
...
(cell-capacity-copy cell-4-9 cap-4)
(cell-capacity-copy cell-2-5 cap-4)
(cell-edge cell-0-6 cell-0-7 n-0-7 n-1-7)
(node-degree0 n-6-4)
(cell-edge-copy cell-2-9 cell-outside-2-right n-2-10 n-3-10)
...
(cell-edge-copy cell-5-9 cell-outside-5-right n-5-10 n-6-10)
...
(cell-capacity-copy cell-1-9 cap-4)
...
(cell-edge-copy cell-5-8 cell-outside-8-down n-6-8 n-6-9)
...
(cell-capacity-copy cell-2-6 cap-3)
...
(cell-edge-copy cell-5-7 cell-outside-7-down n-6-7 n-6-8)
...
(cell-capacity-copy cell-2-4 cap-3)
...
(cell-edge-copy cell-3-9 cell-outside-3-right n-3-10 n-4-10)
...
(cell-capacity-copy cell-4-5 cap-3)
(cell-capacity-inc-copy cap-2 cap-3)
(cell-capacity-copy cell-2-9 cap-1)
...
(cell-capacity-copy cell-4-8 cap-1)
...
(cell-edge-copy cell-0-9 cell-outside-0-right n-0-10 n-1-10)
...
(cell-edge-copy cell-4-9 cell-outside-4-right n-4-10 n-5-10)
...
(cell-edge-copy cell-1-9 cell-outside-1-right n-1-10 n-2-10)
...
(cell-edge-copy cell-5-6 cell-outside-6-down n-6-6 n-6-7)
(cell-edge-copy cell-3-4 cell-4-4 n-4-4 n-4-5)
(node-degree0 n-0-8)
(cell-edge cell-1-2 cell-1-3 n-1-3 n-2-3)
(cell-capacity-copy cell-5-9 cap-3)
