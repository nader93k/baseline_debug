(define (problem sliterlink-662527)                       (:domain slitherlink)                       (:objects cell-outside-7-left - cell
cell-5-4 - cell
n-4-7 - node
cell-6-4 - cell
cell-7-6 - cell
...
(cell-edge-copy cell-5-6 cell-outside-5-right n-5-7 n-6-7)
...
(cell-edge-copy cell-6-6 cell-outside-6-right n-6-7 n-7-7)
(node-degree0 n-0-7)
...
(cell-capacity-copy cell-4-4 cap-2)
(cell-edge-copy cell-6-5 cell-6-6 n-6-6 n-7-6)
(node-degree0 n-5-0)
(node-degree0-copy n-1-6)
(cell-edge-copy cell-0-6 cell-outside-0-right n-0-7 n-1-7)
...
(cell-capacity-copy cell-2-3 cap-3)
(node-degree0 n-8-3)
(cell-edge cell-4-6 cell-5-6 n-5-6 n-5-7)
(cell-capacity cell-outside-3-up cap-1)
(cell-edge-copy cell-4-6 cell-outside-4-right n-4-7 n-5-7)
...
(cell-edge-copy cell-7-6 cell-outside-7-right n-7-7 n-8-7)
(node-degree0 n-6-2)
(node-degree0 n-5-2)
(cell-capacity-copy cell-outside-7-right cap-1)
(cell-capacity-copy cell-1-6 cap-1)
...
(node-degree0 n-3-6)
(cell-capacity-copy cell-3-5 cap-1)
...
(node-degree0 n-2-3)
(cell-capacity-copy cell-2-5 cap-3)
...
(cell-capacity-copy cell-2-1 cap-1)
(cell-edge-copy cell-7-2 cell-outside-2-down n-8-2 n-8-3)
(cell-edge-copy cell-1-6 cell-outside-1-right n-1-7 n-2-7)
...
(cell-edge-copy cell-2-6 cell-outside-2-right n-2-7 n-3-7)
...
(cell-capacity-copy cell-3-6 cap-3)
...
(cell-capacity-copy cell-7-5 cap-3)
(node-degree0 n-0-0)
...
(cell-edge-copy cell-3-6 cell-outside-3-right n-3-7 n-4-7)
...
(node-degree0 n-4-1)
(cell-capacity-copy cell-0-6 cap-3)
...
(cell-capacity-copy cell-5-1 cap-2)
