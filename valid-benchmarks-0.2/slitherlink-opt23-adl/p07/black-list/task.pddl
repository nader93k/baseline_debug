(define (problem sliterlink-730336)                       (:domain slitherlink)                       (:objects cell-outside-2-up - cell
cell-5-4 - cell
cell-2-0 - cell
n-1-6 - node
...
n-4-5 - node
cell-4-5 - cell)                        (:init (cell-edge cell-3-4 cell-4-4 n-4-4 n-4-5)
...
(cell-capacity-copy cell-2-4 cap-1)
...
(cell-edge-copy cell-5-3 cell-outside-3-down n-6-3 n-6-4)
...
(cell-edge-copy cell-5-2 cell-outside-2-down n-6-2 n-6-3)
...
(cell-capacity-copy cell-2-0 cap-2)
...
(cell-capacity-copy cell-5-2 cap-1)
...
(cell-edge-copy cell-5-1 cell-outside-1-down n-6-1 n-6-2)
(cell-capacity cell-outside-3-up cap-1)
(cell-edge cell-3-2 cell-4-2 n-4-2 n-4-3)
(cell-capacity-copy cell-5-5 cap-4)
(cell-edge-copy cell-2-5 cell-outside-2-right n-2-6 n-3-6)
...
(cell-edge-copy cell-5-0 cell-outside-0-down n-6-0 n-6-1)
...
(cell-capacity-copy cell-1-5 cap-3)
...
(node-degree0 n-1-2)
(cell-edge-copy cell-1-5 cell-outside-1-right n-1-6 n-2-6)
(cell-capacity-copy cell-1-2 cap-4)
(cell-edge-copy cell-5-5 cell-outside-5-down n-6-5 n-6-6)
...
(cell-edge-copy cell-5-5 cell-outside-5-right n-5-6 n-6-6)
...
(cell-edge-copy cell-0-5 cell-outside-0-right n-0-6 n-1-6)
(cell-capacity-copy cell-5-4 cap-3)
...
(cell-capacity-copy cell-2-3 cap-2)
(node-degree0 n-3-2)
(node-degree0 n-0-4)
...
(cell-capacity-copy cell-0-3 cap-3)
...
(cell-edge-copy cell-3-5 cell-outside-3-right n-3-6 n-4-6)
...
(cell-edge-copy cell-4-5 cell-outside-4-right n-4-6 n-5-6)
...
(cell-edge-copy cell-5-4 cell-outside-4-down n-6-4 n-6-5)
...
(cell-capacity-copy cell-1-1 cap-3)
...
(cell-edge-copy cell-4-5 cell-5-5 n-5-5 n-5-6))                        (:goal (and
