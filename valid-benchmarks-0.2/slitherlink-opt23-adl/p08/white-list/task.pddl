(define (problem sliterlink-363090)                       (:domain slitherlink)                       (:objects cell-outside-2-up - cell
n-4-7 - node
cell-2-0 - cell
n-1-6 - node
...
n-5-0 - node
n-4-5 - node
cell-4-5 - cell)                        (:init (node-degree0 n-5-7)
...
(node-degree0 n-1-2)
(cell-edge-copy cell-4-6 cell-outside-6-down n-5-6 n-5-7)
(cell-capacity-copy cell-1-2 cap-4)
(cell-capacity-copy cell-0-6 cap-1)
...
(cell-edge-copy cell-4-7 cell-outside-7-down n-5-7 n-5-8)
(node-degree0 n-2-3)
