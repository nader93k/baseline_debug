(define (problem sliterlink-782417)                       (:domain slitherlink)                       (:objects cell-5-4 - cell
n-2-11 - node
...
(cell-capacity-copy cell-4-9 cap-2)
...
(node-degree0-copy n-7-11)
(node-degree0-copy n-1-4)
(cell-edge cell-0-4 cell-0-5 n-0-5 n-1-5)
(cell-edge-copy cell-2-9 cell-3-9 n-3-9 n-3-10)
...
(cell-edge-copy cell-outside-8-up cell-0-8 n-0-8 n-0-9)
(cell-edge-copy cell-6-9 cell-6-10 n-6-10 n-7-10)
...
(cell-capacity-copy cell-5-3 cap-2)
...
(node-degree0-copy n-1-11)
(node-degree0-copy n-3-11)
...
(node-degree0-copy n-5-10)
(cell-edge-copy cell-4-10 cell-outside-4-right n-4-11 n-5-11)
(cell-edge-copy cell-0-7 cell-1-7 n-1-7 n-1-8)
(node-degree0 n-4-4)
(cell-edge-copy cell-4-8 cell-5-8 n-5-8 n-5-9)
...
(cell-capacity-copy cell-1-9 cap-2)
...
(cell-edge-copy cell-3-10 cell-4-10 n-4-10 n-4-11)
...
(cell-capacity-copy cell-3-10 cap-4)
(node-degree0 n-4-0)
(cell-capacity cell-6-8 cap-3)
(cell-edge-copy cell-3-8 cell-4-8 n-4-8 n-4-9)
...
(cell-capacity-copy cell-1-10 cap-4)
...
(node-degree0 n-6-0)
(cell-edge-copy cell-6-8 cell-outside-8-down n-7-8 n-7-9)
(cell-edge-copy cell-0-0 cell-0-1 n-0-1 n-1-1)
(node-degree0-copy n-5-11)
(node-degree0 n-4-9)
...
(cell-capacity-copy cell-2-9 cap-2)
...
(node-degree0 n-2-7)
(node-degree0 n-5-6)
(cell-capacity-copy cell-2-10 cap-4)
...
(cell-edge-copy cell-1-7 cell-1-8 n-1-8 n-2-8)
(cell-edge-copy cell-6-5 cell-6-6 n-6-6 n-7-6)
(node-degree0 n-5-0)
(node-degree0-copy n-1-6)
(cell-edge-copy cell-5-10 cell-outside-5-right n-5-11 n-6-11)
...
(cell-capacity-copy cell-3-8 cap-1)
(node-degree0-copy n-6-5)
(node-degree0 n-3-0)
(cell-edge-copy cell-0-10 cell-outside-0-right n-0-11 n-1-11)
(cell-edge-copy cell-outside-9-up cell-0-9 n-0-9 n-0-10)
(cell-edge cell-4-5 cell-4-6 n-4-6 n-5-6)
(cell-capacity-copy cell-0-8 cap-4)
(cell-capacity cell-6-9 cap-4)
(cell-edge cell-4-6 cell-5-6 n-5-6 n-5-7)
(cell-capacity-copy cell-3-3 cap-2)
(cell-edge-copy cell-6-5 cell-outside-5-down n-7-5 n-7-6)
...
(cell-capacity-copy cell-5-5 cap-1)
...
(cell-edge-copy cell-1-9 cell-1-10 n-1-10 n-2-10)
...
(node-degree0 n-7-9)
(cell-edge-copy cell-0-9 cell-0-10 n-0-10 n-1-10)
(cell-edge-copy cell-0-4 cell-0-5 n-0-5 n-1-5)
(cell-capacity-copy cell-4-4 cap-1)
(node-degree0-copy n-0-9)
(node-degree0-copy n-2-9)
...
(cell-edge-copy cell-0-8 cell-1-8 n-1-8 n-1-9)
(cell-edge cell-5-5 cell-5-6 n-5-6 n-6-6)
(node-degree0-copy n-2-6)
(cell-capacity-copy cell-6-9 cap-4)
...
(cell-edge-copy cell-3-9 cell-4-9 n-4-9 n-4-10)
(node-degree0 n-5-5)
...
(node-degree0-copy n-2-11)
(cell-capacity-copy cell-outside-10-up cap-1)
...
(cell-edge-copy cell-5-9 cell-6-9 n-6-9 n-6-10)
(cell-capacity-copy cell-outside-2-up cap-1)
(cell-edge-copy cell-4-7 cell-4-8 n-4-8 n-5-8)
(node-degree0-copy n-6-9)
...
(cell-capacity-copy cell-1-8 cap-2)
(cell-capacity-copy cell-outside-9-up cap-1)
...
(cell-capacity-copy cell-0-9 cap-4)
...
(node-degree0 n-3-10)
(cell-edge-copy cell-6-10 cell-outside-6-right n-6-11 n-7-11)
(node-degree0-copy n-4-1)
(node-degree0 n-4-6)
(cell-capacity cell-3-0 cap-3)
(cell-capacity-copy cell-outside-8-down cap-1)
...
(cell-edge-copy cell-0-9 cell-1-9 n-1-9 n-1-10)
(cell-edge-copy cell-5-10 cell-6-10 n-6-10 n-6-11)
(cell-edge cell-5-1 cell-5-2 n-5-2 n-6-2)
(cell-capacity cell-outside-4-down cap-1)
(cell-capacity cell-4-2 cap-4)
(node-degree0 n-6-7)
(cell-edge-copy cell-4-8 cell-4-9 n-4-9 n-5-9)
(node-degree0 n-3-6)
...
(node-degree0-copy n-7-10)
(cell-edge cell-1-3 cell-1-4 n-1-4 n-2-4)
(cell-capacity cell-0-10 cap-4)
(node-degree0-copy n-5-9)
(cell-edge-copy cell-6-9 cell-outside-9-down n-7-9 n-7-10)
(node-degree0 n-7-11)
...
(cell-edge-copy cell-6-10 cell-outside-10-down n-7-10 n-7-11)
(node-degree0 n-7-4)
(cell-edge cell-4-3 cell-4-4 n-4-4 n-5-4)
(cell-edge-copy cell-1-8 cell-1-9 n-1-9 n-2-9)
...
(node-degree0-copy n-4-10)
(cell-capacity-copy cell-3-0 cap-3)
(cell-edge-copy cell-6-6 cell-outside-6-down n-7-6 n-7-7)
...
(cell-edge-copy cell-1-9 cell-2-9 n-2-9 n-2-10)
...
(cell-edge-copy cell-2-10 cell-3-10 n-3-10 n-3-11)
...
(cell-edge-copy cell-3-9 cell-3-10 n-3-10 n-4-10)
(cell-capacity-copy cell-0-10 cap-4)
(node-degree0 n-5-1)
...
(cell-edge-copy cell-3-8 cell-3-9 n-3-9 n-4-9)
...
(cell-edge-copy cell-4-9 cell-4-10 n-4-10 n-5-10)
(cell-edge-copy cell-2-8 cell-3-8 n-3-8 n-3-9)
(cell-edge cell-0-10 cell-1-10 n-1-10 n-1-11)
(cell-capacity-copy cell-outside-8-up cap-1)
...
(cell-capacity-copy cell-5-8 cap-4)
(cell-edge-copy cell-1-10 cell-2-10 n-2-10 n-2-11)
(node-degree0-copy n-4-4)
(cell-edge cell-2-10 cell-outside-2-right n-2-11 n-3-11)
(cell-edge cell-4-6 cell-4-7 n-4-7 n-5-7)
(cell-edge-copy cell-outside-10-up cell-0-10 n-0-10 n-0-11)
...
(cell-edge-copy cell-2-9 cell-2-10 n-2-10 n-3-10)
...
(cell-capacity-copy cell-5-4 cap-2)
...
(cell-edge-copy cell-1-10 cell-outside-1-right n-1-11 n-2-11)
...
(cell-capacity-copy cell-1-7 cap-3)
...
(node-degree0-copy n-4-9)
(cell-capacity-copy cell-4-3 cap-2)
...
(cell-capacity-copy cell-outside-10-down cap-1)
...
(node-degree0 n-2-10)
(node-degree0-copy n-0-10)
(cell-capacity-copy cell-outside-9-down cap-1)
(cell-edge-copy cell-6-8 cell-6-9 n-6-9 n-7-9)
(cell-edge-copy cell-5-7 cell-5-8 n-5-8 n-6-8)
...
(cell-capacity-copy cell-6-10 cap-4)
(node-degree0-copy n-2-7)
(cell-capacity-copy cell-5-0 cap-3)
...
(cell-edge-copy cell-1-8 cell-2-8 n-2-8 n-2-9)
(node-degree0 n-2-1)
...
(cell-capacity-copy cell-6-6 cap-4)
...
(cell-capacity-copy cell-4-10 cap-4)
(cell-edge cell-5-5 cell-6-5 n-6-5 n-6-6)
(cell-capacity-copy cell-0-4 cap-3)
(node-degree0 n-3-1)
(cell-capacity-copy cell-4-6 cap-1)
(cell-edge-copy cell-4-9 cell-5-9 n-5-9 n-5-10)
(cell-edge-copy cell-4-10 cell-5-10 n-5-10 n-5-11)
(cell-edge cell-3-8 cell-4-8 n-4-8 n-4-9)
(node-degree0 n-6-9)
(cell-capacity-copy cell-outside-2-left cap-1)
(node-degree0-copy n-7-9)
...
(cell-edge-copy cell-6-7 cell-outside-7-down n-7-7 n-7-8)
(cell-capacity cell-4-1 cap-0)
(cell-edge-copy cell-0-10 cell-1-10 n-1-10 n-1-11)
...
(node-degree0 n-4-1)
(cell-edge-copy cell-0-8 cell-0-9 n-0-9 n-1-9)
...
(cell-edge-copy cell-6-4 cell-outside-4-down n-7-4 n-7-5)
(cell-edge-copy cell-2-6 cell-2-7 n-2-7 n-3-7)
(cell-edge-copy cell-3-10 cell-outside-3-right n-3-11 n-4-11)
(cell-capacity cell-outside-10-down cap-1)
(cell-capacity cell-outside-4-left cap-1)
(cell-edge-copy cell-0-7 cell-0-8 n-0-8 n-1-8)
(node-degree0 n-6-8)
...
(cell-edge-copy cell-5-8 cell-6-8 n-6-8 n-6-9)
(cell-edge-copy cell-3-4 cell-4-4 n-4-4 n-4-5)
(cell-capacity-copy cell-4-1 cap-0)
(node-degree0 n-0-8)
...
(cell-capacity-copy cell-5-6 cap-3)
(node-degree0-copy n-3-10)
(cell-capacity-copy cell-3-1 cap-2)
(cell-capacity cell-2-7 cap-4)
(cell-edge-copy cell-4-5 cell-5-5 n-5-5 n-5-6)
(cell-edge-copy cell-5-9 cell-5-10 n-5-10 n-6-10)
