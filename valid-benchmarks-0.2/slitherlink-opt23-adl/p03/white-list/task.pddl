(define (problem sliterlink-388714)                       (:domain slitherlink)                       (:objects cell-outside-2-up - cell
cell-2-0 - cell
n-1-6 - node
n-3-6 - node
n-0-1 - node
...
n-4-5 - node)                        (:init (node-degree0-copy n-1-6)
...
(cell-capacity-copy cell-3-4 cap-2)
...
(cell-capacity-copy cell-0-5 cap-2)
