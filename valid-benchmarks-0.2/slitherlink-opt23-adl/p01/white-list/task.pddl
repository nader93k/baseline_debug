(define (problem sliterlink-999868)                       (:domain slitherlink)                       (:objects cell-outside-2-down - cell
n-3-1 - node
...
n-0-3 - node)                        (:init (cell-capacity-copy cell-0-2 cap-4)
...
(cell-edge-copy cell-2-0 cell-outside-0-down n-3-0 n-3-1)
...
(cell-capacity-copy cell-2-1 cap-3)
...
(cell-edge-copy cell-2-2 cell-outside-2-down n-3-2 n-3-3)
...
(cell-edge-copy cell-2-3 cell-outside-3-down n-3-3 n-3-4)
...
(cell-edge-copy cell-2-1 cell-outside-1-down n-3-1 n-3-2)
