(define (problem sliterlink-204367)                       (:domain slitherlink)                       (:objects cell-outside-3-right - cell
cell-4-1 - cell
...
n-0-3 - node)                        (:init (node-degree0 n-5-0)
...
(cell-edge-copy cell-1-2 cell-outside-1-right n-1-3 n-2-3)
(cell-edge-copy cell-4-2 cell-outside-4-right n-4-3 n-5-3)
...
(cell-edge-copy cell-3-2 cell-outside-3-right n-3-3 n-4-3)
...
(cell-capacity-copy cell-4-0 cap-3)
...
(node-degree0 n-3-2)
(node-degree0 n-3-1)
(cell-edge-copy cell-2-2 cell-outside-2-right n-2-3 n-3-3)
...
(cell-capacity-copy cell-4-2 cap-3)
...
(cell-capacity-copy cell-1-0 cap-1)
...
(cell-edge cell-2-0 cell-2-1 n-2-1 n-3-1))                        (:goal (and
