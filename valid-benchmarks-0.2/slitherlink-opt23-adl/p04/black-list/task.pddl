(define (problem sliterlink-435500)                       (:domain slitherlink)                       (:objects cell-outside-2-up - cell
cell-2-0 - cell
...
n-5-1 - node
n-0-2 - node
cap-1 - cell-capacity-level)                        (:init (cell-capacity-copy cell-outside-4-left cap-1)
...
(cell-capacity-copy cell-2-1 cap-0)
...
(cell-edge-copy cell-6-2 cell-outside-2-down n-7-2 n-7-3)
...
(cell-capacity-copy cell-3-2 cap-3)
...
(cell-edge-copy cell-6-0 cell-outside-0-down n-7-0 n-7-1)
...
(cell-capacity-copy cell-1-2 cap-3)
(cell-edge-copy cell-6-1 cell-outside-1-down n-7-1 n-7-2)
...
(cell-capacity-copy cell-0-1 cap-1)
...
(cell-edge-copy cell-6-3 cell-outside-3-down n-7-3 n-7-4)
