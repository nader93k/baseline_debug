(define (problem hiking-2-4)                       (:domain hiking)                       (:objects place1 - place
couple1 - couple
car1 - car
couple0 - couple
place0 - place
...
tent1 - tent
girl0 - person
guy1 - person)                        (:init (unlock-origin-domain )
...
(next place0 place1)
(down-copy tent1)
(at_car-copy car3 place0)
(at_person-copy guy1 place0)
(at_car car1 place0)
(partners couple0 guy0 girl0)
(at_person girl0 place0))                        (:goal (and
