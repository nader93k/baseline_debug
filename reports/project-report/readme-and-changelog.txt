Version: see bottom for latest version number and a change log list
...
// Note that some details mention section numbers. They can however change of course. Sorry... :)
   Also, note that the version numbers don't follow a clear systematicity as they would for
   professional projects; I instead just went by gut-feeling. Sorry about that as well.

1.10: 18.5.2025
          - Apparently, the project did not compile under Linux. This is now resolved.

1.094: 6.3.2025
          - updated CECC college to "Systems and Society"

1.093: 8.10.2024
          - updated the academic integrity statement to newest version
...
1.01: 29.9.2022
            - added two more pieces of advice to the main section:
              ...
              * some starting points for how to write mathematical equations/formulae
1.001: 25.9.2022
